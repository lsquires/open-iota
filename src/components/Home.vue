            ...
            <form class="has-text-centered">
              <b-field position="is-centered" :message="isValidSearch ? '' : 'Invalid address/hash/tag'">
                ...
                <b-select placeholder="Type" v-model="searchType">
                  ...
                  <button class="button is-primary is-outlined is-inverted" :disabled="iota === null" type="submit" :submit.prevent="searchNow" @click="searchNow">Search</button>
                </b-field>
              </b-field>
            </form>
          </div>
    ...
    <div class="hero is-success is-bold" v-if="$route.name === 'Home'">
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <div class="container has-text-centered">
            <button class="button is-success is-inverted is-large is-outlined" :disabled="iota === null">Import</button>
          </div>
        </div>
      </div>
    </div>
